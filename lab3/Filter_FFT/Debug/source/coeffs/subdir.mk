...
C_SRCS += \
../source/coeffs/filter_coeffs.c 

C_DEPS += \
./source/coeffs/filter_coeffs.d 

OBJS += \
./source/coeffs/filter_coeffs.o 


# Each subdirectory must supply rules for building sources it contributes
source/coeffs/%.o: ../source/coeffs/%.c source/coeffs/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-coeffs

clean-source-2f-coeffs:
	-$(RM) ./source/coeffs/filter_coeffs.d ./source/coeffs/filter_coeffs.o

.PHONY: clean-source-2f-coeffs
